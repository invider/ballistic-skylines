...
module.exports = function(e) {
    ...
    case ',': lab.camControls.move({dir:lab.camControls.left}); break;
    case '.': lab.camControls.move({dir:lab.camControls.right}); break;
    case '/': lab.camControls.move({center:true}); break;
    }
}
